...
lblSearch=Label(SearchFrame,font=('Algerian',12,'bold'),text="Searching Form",fg='black',justify=CENTER)
...
def Delete():
        ...
        if (PId =="" ):
          messagebox.showinfo("information","enter ID to delete")   
...
btn3 = Button(RegistrationFrame,text="Update",bd=5,bg='green',width=15,command=update).place(x=300,y=230)
    ...
    #=============================Patient Search==========================================================================
#ass = Label(SearchFrame ,width=25,text = "Search Key",font=('Algerian',12,'bold')).grid(row = 1,column = 0,pady=(10, 10),padx=(5, 0))


#s1 = Entry(SearchFrame,width=30,bd=10)
#s1.grid(row = 1,column = 1,pady=(10, 10))

btn1 = Button(SearchFrame,text="Refresh",bd=10,bg='grey',width=15,command=show).grid(row = 1,column = 2,padx=(5, 0))
...
Listbox.bind('<Double-Button-1>',GetValue)
    ...
    #================================Segmentation=======================================================================
btn2 = Button(SegmentationFrame,font=('Algerian',12,'bold'),text="Go To Segmention Form",width=25,bd=10,bg='light green',
