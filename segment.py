...
def openNewWindow(master):
    ...
    btn1 = Button(newWindow,text="File",bd=10,bg='grey',width=20,command=lambda:file_opener()).grid(row = 1,column = 2,padx=(5, 0))
    btn2 = Button(newWindow,text="Detect",bd=10,bg='light green',width=20,command=SEGMENTTEST).grid(row = 1,column = 3,padx=(5, 0))
